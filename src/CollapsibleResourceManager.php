...
use codicastudio\CollapsibleResourceManager\Resources\TopLevelResource;
...
class CollapsibleResourceManager extends Tool
{
    ...
    public function boot()
    {
        ...
        Nova::script('admin-navigation', __DIR__ . '/../dist/js/tool.js');
    ...
    {
        return view('admin-navigation::navigation', [
